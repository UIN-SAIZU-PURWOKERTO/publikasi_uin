...
document.addEventListener("DOMContentLoaded", function () {
    ...
    "chart_faculty_pub",
        <?= json_encode($scholar_faculty_pub) ?>
    );


    buildLineChartPublikasi(
        "chart_ftik_pub",
        <?= json_encode($scholar_ftik_pub) ?>,
        "FTIK",
        "#36A2EB"
    );
    ...
    buildLineChartPublikasi(
        "chart_dakwah_pub",
        <?= json_encode($scholar_dakwah_pub) ?>,
        "Dakwah",
        "#FF9F40"
    );
    ...
    buildLineChartPublikasi(
        "chart_syariah_pub",
        <?= json_encode($scholar_syariah_pub) ?>,
        "Syariah",
        "#4BC0C0"
    );
